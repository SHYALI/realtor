    ...
    <section>
        ...
        <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
            ...
            <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6 ">
                ...
                <img className="w-full rounded-2xl" src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="keys" />
                ...
                <input 
                 type="text"
                  id="name"
                   ...
                   className="w-full mb-6 px-4 py-2 text-xl text-gray-black bg-white border-gray-300 rounded transition ease-in-out " />
                ...
                <input 
                 type={showPassword ? "text" : "password"}
                  id="password"
                   ...
                   className="w-full px-4 py-2 text-xl text-gray-black bg-white border-gray-300 rounded transition ease-in-out " />
